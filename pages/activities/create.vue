...
const createActivity = async () => {
    ...
    await useFetch(`${pawraPath.value}/admin/activities/`, {
        ...
        onResponseError: (res) => {
            useAlertMessage().value = 'failed to create activity';
        ...
        useAlertMessage().value = 'activity created successfully';
...
<template>
    <form autocomplete="off">
        <div class="space-y-12">
            <div class="pb-12">
                <div class="flex items-center justify-between">
                    <div>
                        <h2 class="text-base font-semibold leading-7 text-white">Create activity</h2>
                ...
                <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                    <div class="sm:col-span-4">
                        ...
                        <div class="mt-2">
                            <Select :data="listDogs" v-model="activity.dog_id"/>
                        </div>
                    </div>
                    ...
                    <div class="sm:col-span-4">
                        ...
                        <div class="mt-2">
                            <Multiselect :data="listTags" v-model="activity.tags"/>
                        </div>
                    </div>
        ...
        <div class="mt-6 flex items-center justify-end gap-x-6">
            ...
            <button type="submit" @click.prevent="createActivity" :disabled="loading"
