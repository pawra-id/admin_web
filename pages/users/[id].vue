...
<template>
    <form autocomplete="off" @submit.prevent="updateUser">
            ...
            <div class="pb-12">
                ...
                <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                    ...
                    <div class="sm:col-span-4">
                        ...
                        <div class="mt-2">
                            <Select :data="listRoles" v-model="user.role" :initial="listRoles.find(role => role.value === user.role)"/>
                        </div>
                    </div>
        ...
        <div class="mt-6 flex items-center justify-end gap-x-6">
            <NuxtLink to="/users" class="text-sm font-semibold leading-6 text-white">Cancel</NuxtLink>
