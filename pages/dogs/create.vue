...
const createDog = async () => {
    loading.value = true;
    await useFetch(`${pawraPath.value}/dogs/`, {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json',
            'Accept': 'application/json',
        ...
        onResponseError: (res) => {
            useAlertMessage().value = 'failed to create dog';
        ...
        useAlertMessage().value = 'Dog created successfully';
...
<template>
    <form autocomplete="off" @submit.prevent="createDog">
        <div class="space-y-12">
            <div class="pb-12">
                <div class="flex items-center justify-between">
                    <div>
                        <h2 class="text-base font-semibold leading-7 text-white">Create dog</h2>
                ...
                <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                    ...
                    <div class="sm:col-span-4">
                        ...
                        <div class="mt-2">
                            <Select :data="listUsers" v-model="dog.owner_id" />
                        </div>
                    </div>
                    <div class="sm:col-span-4">
                        ...
                        <div class="mt-2">
                            <Select :data="listGender" v-model="dog.gender" />
                        </div>
                    </div>
                    <div class="sm:col-span-4">
                    ...
                    <div class="sm:col-span-4">
                        ...
                        <div class="mt-2">
                            <div
                                ...
                                <input v-model="dog.breed" type="text" name="breed" id="breed" maxlength="12"
                                    class="flex-1 border-0 bg-transparent py-1.5 pl-3 text-white focus:ring-0 sm:text-sm sm:leading-6" />
                            </div>
                        </div>
                    </div>
                    <div class="sm:col-span-4">
                        <label for="microchip_id" class="block text-sm font-medium leading-6 text-white">Microchip
                            ID</label>
                        <div class="mt-2">
                            <div
                                class="flex rounded-md bg-white/5 ring-1 ring-inset ring-white/10 focus-within:ring-2 focus-within:ring-inset focus-within:ring-emerald-500">

                                <input v-model="dog.microchip_id" type="text" name="microchip_id" id="microchip_id"
                                    class="flex-1 border-0 bg-transparent py-1.5 pl-3 text-white focus:ring-0 sm:text-sm sm:leading-6" />
                            </div>
                        </div>
                    </div>
                    <div class="sm:col-span-4">
                        ...
                        <div class="mt-2">
                            <div
                                ...
                                <input v-model="dog.color" type="text" name="color" id="color" maxlength="12"
                                    class="flex-1 border-0 bg-transparent py-1.5 pl-3 text-white focus:ring-0 sm:text-sm sm:leading-6" />
                            </div>
                        </div>
                    </div>
                    <div class="sm:col-span-4">
                        <label for="role" class="block text-sm font-medium leading-6 text-white">Neutered</label>
                        <div class="mt-2">
                            <Select :data="listSelect" v-model="dog.neutered" />
                        </div>
                    </div>
                    <div class="sm:col-span-4">
                        <div class="grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                            <div class="sm:col-span-3">
                                ...
                                <div class="mt-2">
                                    <input type="number" name="weight" id="weight" autocomplete="given-name"
                            ...
                            <div class="sm:col-span-3">
                                ...
                                <div class="mt-2">
                                    <input type="number" placeholder="17:00" maxlength="5" v-model="dog.height"
                                        name="height" id="height" autocomplete="family-name"
                                        class="block w-full rounded-md border-0 bg-white/5 py-1.5 text-white shadow-sm ring-1 ring-inset ring-white/10 focus:ring-2 focus:ring-inset focus:ring-indigo-500 sm:text-sm sm:leading-6" />
                                </div>
                            </div>
                        </div>
